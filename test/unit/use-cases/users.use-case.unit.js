...
describe('#users-use-case', () => {
  ...
  describe('#updateUser', () => {
    ...
    it('should throw an error if non-string profilePictureUrl given', async () => {
      try {
        const newData = {
          email: 'test@test.com',
          name: 'test',
          profilePictureUrl: 1234
        }
    ...
    it('should throw an error if non-string about given', async () => {
      try {
        const newData = {
          email: 'test@test.com',
          name: 'test',
    ...
    it('should throw an error if non-string website given', async () => {
      try {
        const newData = {
          email: 'test@test.com',
          name: 'test',
